...
import { addBid, createCheckoutSession, deleteBid, getBids } from "../../../../apiCalls/bids";
...
const ChatPage = () => {
    ...
    return (
        <Container maxWidth="lg">
            ...
            <Drawer anchor="left" open={isLeftDrawerOpen} onClose={closeLeftDrawer}>
                ...
                <Box sx={{ width: 250, marginLeft: 2 }}>
                    ...
                    <List>
                        <ListItem>
                            <Avatar sx={{ mr: 1 }} src={sender?.profilePicture} />

                            <ListItemText primary={`${sender?.name} (Me)`} />
                        </ListItem>
                        <ListItem>
                            <Avatar sx={{ mr: 1 }} src={receiver?.profilePicture} />

                            <ListItemText primary={receiver?.name + " (Receiver)"} />
                        </ListItem>
                    </List>
                    <Divider sx={{ mb: 2 }} />
                    <Typography variant="h6">
                        {receiver?.role === "papermaker" ? "Paper Maker" : "Seller"} Details
                    </Typography>
                    <List dense>
                        {receiver?.role === "supplier" && (
                            <ListItem>
                                <Rating
                                    ...
                                    size="small"
                                />
                                <ListItemText secondary={`${receiver?.totalRatings} reviews`} />
                            </ListItem>
                        )}
                        <ListItem>
                            <ListItemText secondary={`Name : ${receiver?.name}`} />
                        </ListItem>
                        <ListItem>
                            <ListItemText secondary={`E-mail : ${receiver?.email}`} />
                        </ListItem>
                        <ListItem>
                            <ListItemText secondary={`Phone No. : ${receiver?.phone}`} />
                        </ListItem>
                        <ListItem>
                            <ListItemText secondary={`Address : ${receiver?.address}`} />
                        </ListItem>
                    </List>
                </Box>
            </Drawer>
            ...
            <Drawer anchor="right" open={isRightDrawerOpen} onClose={closeRightDrawer}>
                    ...
                    <List sx={{ height: "85%", overflowY: "auto" }}>
                        ...
                        {bids.map((bid) => (
                            <Box key={bid._id}>
                                ...
                                >
                                    <ListItemText primary={`Bid Amount: Rs .${bid.bidAmount}`} />
                                    {user.role === "supplier" && (
                                        <IconButton
                                            color="primary"
                                ...
                                <ListItem>
                                    <ListItemText secondary={`Message : ${bid.message}`} />
                                </ListItem>
            ...
            >
                                ...
                                {messages.map((message) => (
                                    <ListItem
                                        ...
                                        sx={{
                                            ...
                                            display: "flex",
                                            textAlign:
                                                message.userId === sender?._id ? "right" : "left",
                                            alignItems: "center",
                                        }}
                                    >
                ...
                {/* Add Bid Dialog */}
                <Dialog open={isBidDialogOpen} onClose={() => setIsBidDialogOpen(false)}>
                    ...
                    <DialogActions>
                        <Button onClick={() => setIsBidDialogOpen(false)}>Cancel</Button>
                        <Button onClick={handleAddBid} variant="contained" color="primary">
                            Add Bid
                        </Button>
                    </DialogActions>
                </Dialog>
