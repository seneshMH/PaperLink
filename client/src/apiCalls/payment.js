...
export const getPaymentDetailsByUserId = async (id) => {
    try {
        const response = await axiosInstance.post("/api/payments/get-payment-details-by-user-id", {
            id,
        });
        return response.data;
    } catch (error) {
...
export const ReleasePaymentFromHold = async (orderId) => {
    try {
        const response = await axiosInstance.post("/api/payments/release-paper-order-payment", {
            orderId,
        });
        return response.data;
    } catch (error) {
...
export const RefundPaperOrderPayment = async (orderId) => {
    try {
        const response = await axiosInstance.post("/api/payments/refund-paper-order-payment", {
            orderId,
        });
        return response.data;
    } catch (error) {
